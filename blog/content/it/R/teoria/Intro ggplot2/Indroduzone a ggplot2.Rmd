...
Queste componenti sono in tutto 8: \* Data \* Mapping \* Geometries \* Statistics \* Scales \* Facets \* Coordinates \* Theme
...
```{r geom1, fig.cap='Stessi dati ma geom_ diverse. In alto geom_point(), in basso geom_smooth()', tidy=FALSE, message = FALSE, echo=FALSE}
...
*Esempio* Si vogliano evidenziare in uno scatter plot tra mpg e hp, quali vetture pesano meno di 3.250.
